...
<body>
    ...
    <div id= "info">
        ...
        <div class = "cardInfo center">
            ...
            <input id = "ordererName" class="inputInfo"placeholder = "주문자 이름" disabled/>
            <input id = "ordererEmail"class="inputInfo" placeholder = "주문자 이메일" type = "email" disabled/>
            <input id = "ordererPhone" class="inputInfo" oninput = "phoneReg(this)" maxlength="13" placeholder = "주문자 휴대전화 번호" disabled/>
            <input id = "ordererMessage" class="inputInfo"placeholder = "메시지"/>

        </div>
        <div class = "cardInfo center">
            <div class="title">수령인 정보</div>
            <button id = "equalBtn" class = "orderBtn"></button>
            <input id = "recipientName" class="inputInfo"placeholder = "수령인 이름" />
            <input id = "recipientEmail"class="inputInfo" placeholder = "수령인 이메일" />
            <input id = "recipientPhone" class="inputInfo" oninput = "phoneReg(this)" maxlength="13" placeholder = "수령인 휴대전화 번호" />
            
            <button class="orderBtn"onclick = "findAddr()" >주소 찾기</button>
            <div>
                <input id="recipientPost" class="inputInfo" placeholder = "우편 번호" disabled/>
                <input id="recipientAddr" class="inputInfo" placeholder = "주소" disabled />
                <input id="recipientAddrDetail" class="inputInfo" placeholder = "상세 주소"/>
            </div>
        </div>
        <div id="lastInfo" class = "cardInfo center">
            <div class="title">최종 주문 정보</div>
            <div>배송비 : 무료</div>
            <div id="lastPrice"></div>
            <div>이체 계좌번호 : 농협 (장주영) 302-9964-8294-11</div>
            <button id = "submitBtn" class="orderBtn">주문 하기</button>
